DROP DATABASE if EXISTS employees_xml;

CREATE DATABASE employees_xml;
USE employees_xml;
...
SELECT ExtractValue(document, 'count(//employee)') AS Total_Empleats 
FROM employees;