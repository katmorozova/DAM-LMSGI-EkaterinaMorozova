DROP DATABASE IF EXISTS empresa_json;

CREATE DATABASE IF NOT EXISTS empresa_json;
USE empresa_json;

-- Tabla para las oficinas
...
('{"employeeNumber": 1188, "lastName": "Firrelli", "Julie": "Diane", "extension": "x2173", "email": "jfirrelli@classicmodelcars.com", "officeCode": "2", "reportsTo": 1056, "jobTitle": "Sales Rep"}'),
